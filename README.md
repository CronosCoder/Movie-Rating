...
This is a movie rating app fronted build with react and javascript. where uses can logi, register,add movie,see all movie detals and provie rating.


## API Home Page

![App Screenshot](https://i.ibb.co/sg3qRHd/Capture1.png)
